...
void loop() {
  ...
  for(levelCount = 1; levelCount <=3; levelCount++){
    if(NoOfChances > 0){
      //      lcd.println("No of chnces : ");
      //      lcd.print(NoOfChances, DEC);
      //      lcd.println("LevelCount : ");
      //      lcd.print(levelCount, DEC);
      delay(1000);
      ...
      lcd.drawText((lcd.getWidth()/2)-50, (lcd.getHeight()/2)-10, "test 1", 1, RGB(255,0,0), RGB(255,255,255));
      lcd.println("Game Over");
      lcd.println("You Loose");
      lcd.drawText((lcd.getWidth()/2)-50, (lcd.getHeight()/2)-10, "test 1", 1, RGB(0,0,0), RGB(255,255,255));
      delay(1000);
      NoOfChances = 3;
      Score = 0;
      levelCount = 0;
